...
RUN echo "\n# Use Clang instead of GCC." >> $HOME/.bashrc \
 && echo "CC=\"clang-9\"" >> $HOME/.bashrc \
 && echo "CXX=\"clang++-9\"" >> $HOME/.bashrc \
 && echo "HOST_CC=\"clang-9\"" >> $HOME/.bashrc \
 && echo "HOST_CXX=\"clang++-9\"" >> $HOME/.bashrc \
 && echo "LIBCLANG_PATH=\"/usr/lib/clang/9/lib\"" >> $HOME/.bashrc
